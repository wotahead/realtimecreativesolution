					...
					<div style="display: table-row; height: 100%;">
						<div class="adminmenubar">
							<div class="stickythingy">
								...
								<div style="text-align: center; padding: 30px; font-size: 10px;"><?php echo uilang("Developed by") ?><br><a target="_blank" class="textlink" style="color: aqua;" href="https://randomlifesss.github.io/project-24-7/"><br>Gagas<br>Rafiq<br>Krisna</a><br><br>Presented by:<br><a href="" class="textlink" style="color: aqua;"><br>Universitas Pamulang<br>Kelompok 5</a></div>
							</div>
						</div>
